@echo off
title VIO-BECTI-WW2.tem_chernarusw Mission gets created
...
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_Svartmarkawintersmall.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
