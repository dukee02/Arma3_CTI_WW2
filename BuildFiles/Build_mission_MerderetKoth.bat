@echo off
title VIO-BECTI-WW2.I44_MerderetKotH Mission gets created
...
set missionfloder="VIO-BECTI-WW2.I44_%Map_name%_koth"
...
copy "%gitpath%\WW2-BECTI.Map_name\RSC\Parameters.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\WW2-BECTI.Map_name\mission_%Map_name%_koth.sqm" "%buildpath%\%missionfloder%\mission.sqm"
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_%Map_name%kothsmall.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
