@echo off
title VIO-BECTI-WW2.Marenice Mission gets created
...
copy "%gitpath%\WW2-BECTI.Map_name\RSC\Parameters_csa.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
