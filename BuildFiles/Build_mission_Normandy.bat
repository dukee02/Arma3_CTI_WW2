@echo off
title VIO-BECTI-WW2.Normandy Mission gets created
...
set Map_name="Normandy"
set missionfloder="VIO-BECTI-WW2.SPE_%Map_name%"
...
copy "%gitpath%\WW2-BECTI.Map_name\RSC\Parameters_SPE.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\WW2-BECTI.Map_name\mission_SPE_%Map_name%.sqm" "%buildpath%\%missionfloder%\mission.sqm"
