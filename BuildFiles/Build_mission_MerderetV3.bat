@echo off
title VIO-BECTI-WW2.I44_Merderet_V3 Mission gets created
...
set missionfloder="VIO-BECTI-WW2.I44_%Map_name%_V3"
...
copy "%gitpath%\WW2-BECTI.Map_name\mission_%Map_name%V3.sqm" "%buildpath%\%missionfloder%\mission.sqm"
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_%Map_name%v3small.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
