@echo off
title VIO-BECTI-WW2.fow_map_henderson Mission gets created
...
set Map_name="henderson"
set missionfloder="VIO-BECTI-WW2.fow_map_henderson"
...
copy "%gitpath%\WW2-BECTI.Map_name\RSC\Parameters_fow.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\WW2-BECTI.Map_name\mission_fow_%Map_name%.sqm" "%buildpath%\%missionfloder%\mission.sqm"
