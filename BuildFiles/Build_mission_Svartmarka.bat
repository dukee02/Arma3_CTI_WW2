@echo off
title VIO-BECTI-WW2.tem_chernarus Mission gets created
...
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_SvartmarkaSmall.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
