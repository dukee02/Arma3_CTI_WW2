@echo off
title VIO-BECTI-WW2.I44_Merderet_V2 Mission gets created
...
set missionfloder="VIO-BECTI-WW2.I44_%Map_name%_V2"
...
copy "%gitpath%\WW2-BECTI.Map_name\mission_%Map_name%V2.sqm" "%buildpath%\%missionfloder%\mission.sqm"
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_%Map_name%v2small.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
