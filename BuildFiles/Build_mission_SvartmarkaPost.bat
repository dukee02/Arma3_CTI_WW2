@echo off
title VIO-BECTI-WW2.tem_chernarusd Mission gets created
...
copy "%gitpath%\WW2-BECTI.Map_name\RSC\Parameters_nf.hpp" "%buildpath%\%missionfloder%\RSC\Parameters.hpp"
...
copy "%gitpath%\WW2-BECTI-Thumpnails\WW2_BECTI_Svartmarkapostwarsmall.jpg" "%buildpath%\%missionfloder%\VIO_BECTI.jpg"
