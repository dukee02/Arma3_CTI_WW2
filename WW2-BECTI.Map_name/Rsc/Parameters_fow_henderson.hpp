class Params {
	...
	class CTI_GUER_TOWNS {
		...
		values[] = {0,1,2};
		texts[] = {"FFI - very easy (IFA3 needed)","Polish Units - easy (IFA3/CSA needed)","3rd Party (needs one Side on GUER or set 50:50 at townsmode)"};
		default = 2;
	};
	...
	class CTI_ECONOMY_RESEARCH_MULTI {
		...
		values[] = {200,300,400,500,600,700,800,900,1000,1500,2000,3000,4000};
		texts[] = {"2x","3x","4x","half","6x","7x","8x","9x","normal","15x","double","30x","40x"};
		default = 1000;
	};
