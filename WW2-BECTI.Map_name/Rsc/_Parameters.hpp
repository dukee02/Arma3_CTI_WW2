class Params {
	...
	class CTI_ECONOMY_STARTUP_FUNDS_EAST_COMMANDER {
		...
		values[] = {10000,15000,20000,25000,30000,35000,40000,45000,50000,60000,80000,100000};
		texts[] = {"$10000","$15000","$20000","$25000","$30000","$35000","$40000","$45000","$50000","$60000","$80000","$100000"};
		default = 10000;
	};
	class CTI_ECONOMY_STARTUP_FUNDS_EAST {
		title = "INCOME: Starting Funds (East Players)";
		values[] = {1000,1500,2400,3200,6000,8000,10000,12500,15000,20000,30000,40000};
		texts[] = {"$1000","$1500","$2400","$3200","$6000","$8000","$10000","$12500","$15000","$20000","$30000","$40000"};
		default = 3200;
	};
	...
	class CTI_ECONOMY_STARTUP_FUNDS_WEST {
		...
		values[] = {1000,1500,2400,3200,6000,8000,10000,12500,15000,20000,30000};
		texts[] = {"$1000","$1500","$2400","$3200","$6000","$8000","$10000","$12500","$15000","$20000","$30000"};
		default = 3200;
	};
	...
	class CTI_ENVIRONMENT_WEATHER_FOG {
		title = "ENVIRONMENT: Weather Fog";
		values[] = {0,1};
		texts[] = {"No Fog","Fog Enabled"};
		default = 1;
	};
	class CTI_ENVIRONMENT_WEATHER_SKIPNIGHT {
		title = "ENVIRONMENT: Weather Skip Night";
		values[] = {0,1};
		texts[] = {"No","Skip"};
		default = 0;
	};
