...
//soundClick[] = {"\A3\ui_f\data\sound\onclick",0.07,1};
//soundEscape[] = {"\A3\ui_f\data\sound\onescape",0.09,1};
soundEnter[] = {"\a3\Ui_f\data\Sound\CfgIngameUI\hint",0.09,1};
soundPush[] = {"\A3\Ui_f\data\Sound\CfgNotifications\addItemOK",0.0,0};
soundClick[] = {"\A3\missions_f\data\sounds\click.wss",0.07,1};
soundEscape[] = {"\A3\Sounds_F\sfx\alarm",0.09,1};
action = "";
class Attributes {
font = "PuristaMedium";
color = "#E5E5E5";
...
class ListScrollBar : BeScrollBar {
};
};
...
maxHistoryDelay = 1.0;
sizeEx = "( ( ( ((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
class ComboScrollBar : BeScrollBar {
};
};
