...
if (isnil "IL_Variables") then
{
	...
	
	{
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1LIB_OpelBlitz_Open_Y_Camo", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1SPE_OpelBlitz_Open", _x])) then {
			IL_Supported_Vehicles_Blitz pushBack format["%1SPE_OpelBlitz_Open", _x];
			IL_Supported_Vehicles_Blitz pushBack format["%1SPE_OpelBlitz", _x];	
		};

		if (isClass(configFile >> "CfgVehicles" >> format["%1CSA38_pragaRV", _x])) then {
	...
	
	{
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1Exile_Bike_OldBike", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1LIB_Zis5v_w", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1CSA38_pzbfwI_W", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1fow_ija_type95_HaGo_1_ija", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1NORTH_FIN_W_41_BA10", _x])) then {
		...
		if (isClass(configFile >> "CfgVehicles" >> format["%1SPE_OpelBlitz", _x])) then {
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG34_Lafette_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG34_Bipod", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG34_Lafette_low_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG34_Lafette_Trench_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG42_Lafette_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG42_Bipod", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG42_Lafette_low_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_MG42_Lafette_trench_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_M1919_M2", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_M1919_M2_Trench_Deployed", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_M1919A6_Bipod", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_GrW278_1", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_M1_81", _x];
			IL_Supported_Mini_Static_Cargo pushBack format["%1SPE_GER_SearchLight", _x];

			IL_Supported_Small_Static_Cargo pushBack format["%1SPE_FlaK_30", _x];
			IL_Supported_Small_Static_Cargo pushBack format["%1SPE_FlaK_38", _x];

			IL_Supported_Medium_Static_Cargo pushBack format["%1SPE_57mm_M1", _x];
			IL_Supported_Medium_Static_Cargo pushBack format["%1SPE_M45_Quadmount", _x];

			IL_Supported_Large_Static_Cargo pushBack format["%1SPE_leFH18", _x];
			IL_Supported_Large_Static_Cargo pushBack format["%1SPE_leFH18_AT", _x];
			IL_Supported_Large_Static_Cargo pushBack format["%1SPE_Pak40", _x];

			IL_Supported_XLarge_Static_Cargo pushBack format["%1SPE_FlaK_36", _x];
			IL_Supported_XLarge_Static_Cargo pushBack format["%1SPE_FlaK_36_AA", _x];

			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Open", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Ammo", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Fuel", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Repair", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Ambulance", _x];	
			IL_Supported_Truck_Cargo pushBack format["%1SPE_OpelBlitz_Flak38", _x];	

			IL_Supported_Armoured_Cargo pushBack format["%1SPE_SdKfz250_1", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Unarmed_Open", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Unarmed", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Ammo", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Fuel", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Repair", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack_Ambulance", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M3_Halftrack", _x];
			IL_Supported_Armoured_Cargo pushBack format["%1SPE_US_M16_Halftrack", _x];

			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_PzKpfwIII_J", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_PzKpfwIII_L", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_PzKpfwIII_M", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_PzKpfwIII_N", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_PzKpfwIV_G", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A0_75_Early", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A0_75", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M10", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A1_75", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A1_T34_Calliope_Direct", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A1_T34_Calliope", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M18_Hellcat", _x];
			IL_Supported_Medium_Tank_Cargo pushBack format["%1SPE_M4A1_76", _x];

			IL_Supported_Large_Tank_Cargo pushBack format["%1SPE_PzKpfwVI_H1", _x];
			IL_Supported_Large_Tank_Cargo pushBack format["%1SPE_Nashorn", _x];
		};
		
		if (isClass(configFile >> "CfgVehicles" >> format["%1SOV_BT_BT7A", _x])) then {
