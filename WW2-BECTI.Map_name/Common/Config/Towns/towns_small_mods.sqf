...
if(CTI_UK_SIDE == (_side) call CTI_CO_FNC_GetSideID) then {
	...
	if(CTI_SABFL_ADDON > 0) then {
		...
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_hurricane", _sid],1]];
		};
		
		_matrix_cnt = [_matrix_cnt, _matrix_full, _matrix_nation] call CTI_CO_FNC_CheckCountUp;
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_hurricane", _sid],1],[format["%1sab_fl_hurricane_trop", _sid],1]];
		};
		
		_matrix_cnt = [_matrix_cnt, _matrix_full, _matrix_nation] call CTI_CO_FNC_CheckCountUp;
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_hurricane", _sid],1],[format["%1sab_fl_hurricane_trop", _sid],1],[format["%1sab_fl_hurricane_2", _sid],1]];
		};
		...
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_hurricane", _sid],1],[format["%1sab_fl_hurricane_trop", _sid],1],[format["%1sab_fl_hurricane_2", _sid],1]];
			AIR_BOMBER = [[format["%1sab_fl_dh98", _sid],1]];
		};
	};
};
if(CTI_US_SIDE == (_side) call CTI_CO_FNC_GetSideID) then {
	...
	if(CTI_SABFL_ADDON > 0) then {
		...
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_p51d", _sid],1]];
		};
	};
};
if(CTI_SOV_SIDE == (_side) call CTI_CO_FNC_GetSideID) then {
	...
	if(CTI_SABFL_ADDON > 0) then {
		...
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER = [[format["%1sab_fl_yak3", _sid],1]];
		};
	};
};
if(CTI_GER_SIDE == (_side) call CTI_CO_FNC_GetSideID) then {
	...
	if(CTI_SABFL_ADDON > 0) then {
		...
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER append [[format["%1sab_fl_bf109e", _sid],1],[format["%1sab_fl_bf109f", _sid],1],[format["%1sab_fl_bf109g", _sid],1],[format["%1sab_fl_fw190a", _sid],1]];
			AIR_BOMBER append [[format["%1sab_fl_ju88a", _sid],1]];
		};
		...
		if(_matrix_cnt >= 0) then {_level = _matrix_cnt; _matrix_cnt = _matrix_cnt + 1;};
		if(CTI_ECONOMY_LEVEL_AIR >= _level) then {
			AIR_FIGHTER append [[format["%1sab_fl_bf109e", _sid],1],[format["%1sab_fl_bf109f", _sid],1],[format["%1sab_fl_bf109g", _sid],1],[format["%1sab_fl_fw190a", _sid],1],[format["%1sab_fl_bf109k", _sid],1]];
			AIR_BOMBER append [[format["%1sab_fl_ju88a", _sid],1]];
		};
	};
};
