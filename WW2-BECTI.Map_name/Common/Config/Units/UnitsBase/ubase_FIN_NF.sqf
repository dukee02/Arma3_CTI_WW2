...
if((_side == west && ((CTI_WEST_AI >= 0 && CTI_WEST_AI == CTI_FIN_ID) ||  CTI_WEST_AI == -1)) || (_side == east && ((CTI_EAST_AI >= 0 && CTI_EAST_AI == CTI_FIN_ID) || CTI_EAST_AI == -1)) || _tag == "GUER_") then {
	switch(CTI_CAMO_ACTIVATION) do {
		case 1: {//Winter camo active
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1I_NORTH_FIN_W_41_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1I_NORTH_FIN_W_41_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1I_NORTH_FIN_T_W_41_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1I_NORTH_FIN_W_41_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1I_NORTH_FIN_W_41_Sentry", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1I_NORTH_FIN_W_41_AIR_Pilot_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1I_NORTH_FIN_ART_W_41_Rifleman", _sid]];
		...
		case 2: {//Summer camo active
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1I_NORTH_FIN_S_41_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1I_NORTH_FIN_S_41_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1I_NORTH_FIN_T_S_41_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1I_NORTH_FIN_S_41_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1I_NORTH_FIN_S_41_Sentry", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1I_NORTH_FIN_S_41_AIR_Pilot_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1I_NORTH_FIN_ART_S_41_Rifleman", _sid]];
			//Set starting vehicles
			if(CTI_STREAM_BLOCK > 0) then {
				missionNamespace setVariable [format["CTI_%1_Vehicles_Startup", _side], [ 
					[format["%1NORTH_FIN_W_39_T26_M31", _sid], []], 
		...
		default {
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1I_NORTH_FIN_41_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1I_NORTH_FIN_ART_41_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1I_NORTH_FIN_T_41_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1I_NORTH_FIN_41_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1I_NORTH_FIN_41_Sentry", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1I_NORTH_FIN_41_AIR_Pilot_SgtMaj", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1I_NORTH_FIN_ART_41_Rifleman", _sid]];
			//Set starting vehicles
			if(CTI_STREAM_BLOCK > 0) then {
				missionNamespace setVariable [format["CTI_%1_Vehicles_Startup", _side], [ 
					[format["%1NORTH_FIN_W_39_T26_M31", _sid], []], 
