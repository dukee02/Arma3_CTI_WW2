...
if (CTI_Log_Level >= CTI_Log_Debug) then {["VIOC_DEBUG", "FILE: common\config\units\unitsbase\ubase_SOV_NF.sqf", format["setting up factory units for side %1", _side]] call CTI_CO_FNC_Log;};
...
if((_side == west && ((CTI_WEST_AI >= 0 && CTI_WEST_AI == CTI_SOV_ID) ||  CTI_WEST_AI == -1)) || (_side == east && ((CTI_EAST_AI >= 0 && CTI_EAST_AI == CTI_SOV_ID) || CTI_EAST_AI == -1)) || _tag == "GUER_") then {
	switch(CTI_CAMO_ACTIVATION) do {
		case 1: {//Winter camo active
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1O_NORTH_SOV_W_41_Officer_Lt", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1O_NORTH_SOV_W_41_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1O_NORTH_SOV_T_W_41_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1O_NORTH_SOV_W_41_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1O_NORTH_SOV_T_W_41_Crewman", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1O_NORTH_SOV_AIR_W_41_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1O_NORTH_SOV_ART_W_41_Rifleman", _sid]];
		...
		case 2: {//Summer camo active
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1O_NORTH_SOV_41_Officer_Lt", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1O_NORTH_SOV_41_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1O_NORTH_SOV_T_41_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1O_NORTH_SOV_41_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1O_NORTH_SOV_T_41_Crewman", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1O_NORTH_SOV_41_AIR_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1O_NORTH_SOV_ART_41_Rifleman", _sid]];
			//Set starting vehicles
			missionNamespace setVariable [format["CTI_%1_Vehicles_Startup", _side], [ 
		...
		default {
			missionNamespace setVariable [format["CTI_%1Commander", _side], format["%1O_NORTH_SOV_W_39_Officer", _sid]];
			missionNamespace setVariable [format["CTI_%1Soldier", _side], format["%1O_NORTH_SOV_ART_W_39_Rifleman", _sid]];
			missionNamespace setVariable [format["CTI_%1Crew", _side], format["%1O_NORTH_SOV_T_W_39_Crewman", _sid]];

			missionNamespace setVariable [format["CTI_%1Worker", _side], format["%1O_NORTH_SOV_W_39_Unequipped", _sid]];
			missionNamespace setVariable [format["CTI_%1Diver", _side], format["%1O_NORTH_SOV_T_W_39_Crewman", _sid]];
			missionNamespace setVariable [format["CTI_%1Pilot", _side], format["%1O_NORTH_SOV_AIR_W_41_Officer_Cpt", _sid]];
			missionNamespace setVariable [format["CTI_%1Static", _side], format["%1O_NORTH_SOV_ART_W_39_Rifleman", _sid]];
			//Set starting vehicles
			missionNamespace setVariable [format["CTI_%1_Vehicles_Startup", _side], [ 
				[format["%1NORTH_SOV_41_T26_M31", _sid], []], 
				[format["%1NORTH_SOV_41_T26_M31", _sid], []]
