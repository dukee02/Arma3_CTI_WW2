			...
			} else {
				{
					...
					if(_teamfunds_stored <= 0) then {
						...
						//if (CTI_Log_Level >= CTI_Log_Debug) then {
							["VIOC_DEBUG", "FILE: Server\Functions\Server_LoadFromProfile.sqf", format["Team funds loaded from profile:<SAVE_%1_FUNDS_%2> Funds: <%3>", _savename, _groupname, (_x) call CTI_CO_FNC_GetFundsTeam]] call CTI_CO_FNC_Log;
						//};
