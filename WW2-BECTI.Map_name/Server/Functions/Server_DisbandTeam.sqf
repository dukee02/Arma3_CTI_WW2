/*
  # HEADER #
	Script: 		Server\Functions\Server_DisbandTeam.sqf
	Alias:			CTI_SE_FNC_DisbandTeam
  ...
  # EXAMPLE #
    ...
    [_selected, 0] call CTI_SE_FNC_DisbandTeam;		//disband only that team

    [grpNull, 2] call CTI_SE_FNC_DisbandTeam;		//disband all teams
*/
